...
class res_config_settings(models.TransientModel):
    ...
    notify_lost_channel_ids = fields.Many2many(
        "mail.channel",
        "mail_channel_res_config_settings_lost_messages_rel_table",
        "mail_channel_id",
        "res_config_settings_id",
        string="Noify channels",
    )
    ...
    def get_values(self):
        ...
        notify_lost_channel_ids = self.env["mail.channel"].search([("id", "in", notify_lost_channel_ids)]).ids
        ...
        values = {
            ...
            "notify_lost_channel_ids": [(6, 0, notify_lost_channel_ids)],
    ...
    def set_values(self):
        ...
        Config.set_param("notify_lost_channel_ids", self.notify_lost_channel_ids.ids)

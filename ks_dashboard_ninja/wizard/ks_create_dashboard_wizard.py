...
class KSCreateDashboardWizard(models.TransientModel):
    ...
    def ks_create_record(self):
        ...
        if ks_create_record.ks_dashboard_menu_id.parent_id.parent_id:
            top_menu_id = ks_create_record.ks_dashboard_menu_id.parent_id.parent_id.id
        else:
            top_menu_id = ks_create_record.ks_dashboard_menu_id.parent_id.id
